...
class Trajectory:
    ...
    _datadefs = {
        ...
        's': { 'matrix': False,  'dtype': np.int32 },
        'l': { 'matrix': False,  'dtype': np.float32 },
        'w': { 'matrix': False,  'dtype': np.float32 },
        'g': { 'matrix': False,  'dtype': np.float32 },
        'n': { 'matrix': False,  'dtype': np.float32 },
    }
    
    _data_names = 'tqxvfslwgn'
