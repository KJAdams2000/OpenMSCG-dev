...
class CGDeriv:
    ...
    def __init__(self, *args, **kwargs):
        ...
        group.add_argument("--ucgwf", metavar='[key=value]', action=WFArgAction, help=WFArgAction.help(), default=[])
    ...
    def process(self):
        ...
        for reader in tqdm.tqdm(TrajBatch(self.args.traj, natoms = self.args.top.n_atom, cut = self.plist.cut)):
            if reader.nread == 1:
            ...
            for types in UCGSpawner(self.args.top, reader.traj):
